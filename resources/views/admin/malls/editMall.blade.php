...
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Edit Mall</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->

        <form action="{{ route('malls.edit') }}" enctype="multipart/form-data" method="POST">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="slug" value="{{ $values['slug'] }}" placeholder="Enter slug name">
                    <span>@error('slug')
                            {{ $message }}
                        @enderror</span>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="address" value={{ $values['address'] }} placeholder="Enter address">
                    <span>@error('address')
                            {{ $message }}
                        @enderror</span>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="lat" value={{ $values['lat']  }} placeholder="Enter Lat">
                    <span>@error('lat')
                            {{ $message }}
                        @enderror</span>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="long" value={{ $values['Long1'] }} placeholder="Enter Long">
                    <span>@error('lat')
                            {{ $message }}
                        @enderror</span>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="phone" value="{{ $values['phone'] }}" placeholder="Enter Phone">
                    <span>@error('phone')
                            {{ $message }}
                        @enderror</span>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="whtssupphone" value="{{ $values['whtssAppPhone'] }}" placeholder="Enter WhttsaapPhone">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="featuredescription" rows="3" value={{ $values['featureDescription'] }} placeholder="Enter ..."></textarea>
                </div>

                <div class="form-group">
                    <label>Service Descrition</label>
                    <textarea class="form-control" name="servicedescription" rows="3" value={{ $values['serviceDescription'] }} placeholder="Enter ..."></textarea>
                </div>
            </div>
    </div>
